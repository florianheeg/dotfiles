...
title: advanced-no-puzzle
description: Avoid type-level cleverness that hurts readability
impact: MEDIUM
impactDescription: Keeps advanced types from becoming maintenance burdens.
---

## ADV-03: Avoid type-level cleverness that hurts readability

**When to apply:** Reviewing a type that needs a comment to explain how it works, or that nests several conditional/mapped types.
