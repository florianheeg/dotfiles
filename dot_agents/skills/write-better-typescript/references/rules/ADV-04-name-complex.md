...
title: advanced-name-complex
description: Name complex type aliases clearly and split them when needed
impact: LOW
impactDescription: Improves maintainability of advanced type logic.
---

## ADV-04: Name complex type aliases clearly and split them when needed

**When to apply:** A type alias has more than one generic parameter or does more than one thing.
