...
title: api-required-input
description: Require the fields a function actually needs
impact: MEDIUM
impactDescription: Reduces weak contracts and makes dependencies explicit.
---

## API-03: Require the fields a function actually needs

**When to apply:** A function only reads a few fields off a large object parameter, especially if that object type then gets reused unnecessarily.
