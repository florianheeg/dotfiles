...
title: model-impossible-state
description: Model impossible states out of existence
impact: HIGH
impactDescription: Prevents contradictory or incomplete state from being representable.
---

## MDL-01: Model impossible states out of existence

**When to apply:** Modeling a value that has several mutually exclusive states (loading/success/error, draft/published) instead of independent booleans and optionals.
