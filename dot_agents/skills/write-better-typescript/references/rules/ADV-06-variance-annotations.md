...
title: type-variance-annotations
description: Understand and control type variance
impact: LOW
impactDescription: Enables explicit control over subtyping in complex generic types.
---

## ADV-06: Understand and control type variance

**When to apply:** Defining a generic type or interface where callers might rely on subtyping in only the input or only the output position.
