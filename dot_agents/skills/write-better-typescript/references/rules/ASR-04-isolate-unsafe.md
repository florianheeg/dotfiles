...
title: assert-isolate-unsafe
description: Isolate unavoidable unsafe typing behind narrow boundaries
impact: MEDIUM
impactDescription: Limits the blast radius of unavoidable unsafety.
---

## ASR-04: Isolate unavoidable unsafe typing behind narrow boundaries

**When to apply:** Interop with an untyped or legacy dependency forces some unavoidable `any`/unsafe code into the codebase.
